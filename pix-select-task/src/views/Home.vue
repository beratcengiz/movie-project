        ...
        <div class="container">
            <div class="row">
                <div class="d-flex justify-content-between w-100" style="margin-top:80px">
                    ...
                    <h6 class="text-secondary">{{ data.length }} sonuç gösteriliyor</h6>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class=" bg-dark text-white w-100 mt-3 mb-3 d-flex justify-content-center" style="border:1px solid white;cursor:pointer" @click="getCount()">Daha Fazla Göster</div>
                </div>
            </div>
        </div>
    </div>
